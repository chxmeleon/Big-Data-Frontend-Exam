...
export const changeString = (str: string | undefined): string | undefined =>
...
export const calcPercentFromTwoValue = (
  ...
  return Math.round((firstValue / secondValue) * 10000) / 100;
};
    ...
    series: [
      {
        name: '男',
        type: 'column',
        data: [data.householdSingleM, data.householdOrdinaryM],
        color: '#7960AD',
      },
      {
        name: '女',
        type: 'column',
        data: [data.householdSingleF, data.householdOrdinaryF],
        color: '#AD8AF8',
      },
    ],
    responsive: {
